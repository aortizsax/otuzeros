REAME: Qiime2 auto cuttoff
#Adrian Ortiz-Velez

This script was created to proved a mathematical backing to eliminting features with 
many zeros.

In this directory 
.
├── DATE_autoCutoff.py      # Reads data and identfies where to cut off the data
